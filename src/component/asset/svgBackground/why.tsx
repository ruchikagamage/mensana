...
import Svg, {Defs, LinearGradient, Stop, Path, G, Text, TSpan, Circle, Ellipse, Mask, Use} from 'react-native-svg';
  ...
  return (
    <Svg width={width} height={379}>
      <Defs>
        ...
        <LinearGradient x1="0%" y1="50%" x2="100%" y2="50%" id="prefix__j">
          <Stop stopColor="gray" stopOpacity={0.25} offset="0%" />
          <Stop stopColor="gray" stopOpacity={0.12} offset="54%" />
          <Stop stopColor="gray" stopOpacity={0.1} offset="100%" />
        </LinearGradient>
        <LinearGradient x1=".017%" y1="50.058%" x2="100.002%" y2="50.058%" id="prefix__k">
          <Stop stopColor="gray" stopOpacity={0.25} offset="0%" />
          <Stop stopColor="gray" stopOpacity={0.12} offset="54%" />
          <Stop stopColor="gray" stopOpacity={0.1} offset="100%" />
        </LinearGradient>
        <LinearGradient x1="0%" y1="50%" x2="100.099%" y2="50%" id="prefix__l">
          <Stop stopColor="gray" stopOpacity={0.25} offset="0%" />
          <Stop stopColor="gray" stopOpacity={0.12} offset="54%" />
          <Stop stopColor="gray" stopOpacity={0.1} offset="100%" />
        </LinearGradient>
        <LinearGradient x1="-.099%" y1="50%" x2="100%" y2="50%" id="prefix__m">
          <Stop stopColor="gray" stopOpacity={0.25} offset="0%" />
          <Stop stopColor="gray" stopOpacity={0.12} offset="54%" />
          <Stop stopColor="gray" stopOpacity={0.1} offset="100%" />
        </LinearGradient>
        <LinearGradient x1="0%" y1="50%" x2="100.036%" y2="50%" id="prefix__n">
          <Stop stopColor="gray" stopOpacity={0.25} offset="0%" />
          <Stop stopColor="gray" stopOpacity={0.12} offset="54%" />
          <Stop stopColor="gray" stopOpacity={0.1} offset="100%" />
        </LinearGradient>
        <LinearGradient x1="0%" y1="49.993%" x2="99.991%" y2="49.993%" id="prefix__o">
          <Stop stopColor="gray" stopOpacity={0.25} offset="0%" />
          <Stop stopColor="gray" stopOpacity={0.12} offset="54%" />
          <Stop stopColor="gray" stopOpacity={0.1} offset="100%" />
        </LinearGradient>
        <LinearGradient x1="0%" y1="50%" x2="100.008%" y2="50%" id="prefix__p">
          <Stop stopColor="gray" stopOpacity={0.25} offset="0%" />
          <Stop stopColor="gray" stopOpacity={0.12} offset="54%" />
          <Stop stopColor="gray" stopOpacity={0.1} offset="100%" />
        </LinearGradient>
        <LinearGradient x1="0%" y1="50%" x2="100%" y2="50%" id="prefix__q">
          <Stop stopColor="gray" stopOpacity={0.25} offset="0%" />
          <Stop stopColor="gray" stopOpacity={0.12} offset="54%" />
          <Stop stopColor="gray" stopOpacity={0.1} offset="100%" />
        </LinearGradient>
        <LinearGradient x1="0%" y1="49.989%" x2="100%" y2="49.989%" id="prefix__r">
          <Stop stopColor="gray" stopOpacity={0.25} offset="0%" />
          <Stop stopColor="gray" stopOpacity={0.12} offset="54%" />
          <Stop stopColor="gray" stopOpacity={0.1} offset="100%" />
        </LinearGradient>
        <LinearGradient x1="0%" y1="49.975%" x2="99.864%" y2="49.975%" id="prefix__s">
          <Stop stopColor="gray" stopOpacity={0.25} offset="0%" />
          <Stop stopColor="gray" stopOpacity={0.12} offset="54%" />
          <Stop stopColor="gray" stopOpacity={0.1} offset="100%" />
        </LinearGradient>
        <LinearGradient x1="0%" y1="49.975%" x2="99.864%" y2="49.975%" id="prefix__t">
          <Stop stopColor="gray" stopOpacity={0.25} offset="0%" />
          <Stop stopColor="gray" stopOpacity={0.12} offset="54%" />
          <Stop stopColor="gray" stopOpacity={0.1} offset="100%" />
        </LinearGradient>
        <LinearGradient x1="50%" y1="100.125%" x2="50%" y2="0%" id="prefix__u">
          <Stop stopColor="gray" stopOpacity={0.25} offset="0%" />
          <Stop stopColor="gray" stopOpacity={0.12} offset="54%" />
          <Stop stopColor="gray" stopOpacity={0.1} offset="100%" />
        </LinearGradient>
        <LinearGradient x1="50%" y1="100%" x2="50%" y2="0%" id="prefix__v">
          <Stop stopColor="gray" stopOpacity={0.25} offset="0%" />
          <Stop stopColor="gray" stopOpacity={0.12} offset="54%" />
          <Stop stopColor="gray" stopOpacity={0.1} offset="100%" />
        </LinearGradient>
        <LinearGradient x1="50%" y1="100%" x2="50%" y2="-.125%" id="prefix__w">
          <Stop stopColor="gray" stopOpacity={0.25} offset="0%" />
          <Stop stopColor="gray" stopOpacity={0.12} offset="54%" />
          <Stop stopColor="gray" stopOpacity={0.1} offset="100%" />
        </LinearGradient>
        <LinearGradient x1="50.007%" y1="100%" x2="50.007%" y2="0%" id="prefix__x">
          <Stop stopColor="gray" stopOpacity={0.25} offset="0%" />
          <Stop stopColor="gray" stopOpacity={0.12} offset="54%" />
          <Stop stopColor="gray" stopOpacity={0.1} offset="100%" />
        </LinearGradient>
        <LinearGradient x1="50.002%" y1="100.002%" x2="50.002%" y2="-.01%" id="prefix__y">
          <Stop stopColor="gray" stopOpacity={0.25} offset="0%" />
          <Stop stopColor="gray" stopOpacity={0.12} offset="54%" />
          <Stop stopColor="gray" stopOpacity={0.1} offset="100%" />
        </LinearGradient>
        <LinearGradient x1="49.936%" y1="100.023%" x2="49.936%" y2="-.069%" id="prefix__z">
          <Stop stopColor="gray" stopOpacity={0.25} offset="0%" />
          <Stop stopColor="gray" stopOpacity={0.12} offset="54%" />
          <Stop stopColor="gray" stopOpacity={0.1} offset="100%" />
        </LinearGradient>
        <LinearGradient x1="49.992%" y1="100%" x2="49.992%" y2="0%" id="prefix__C">
          <Stop stopColor="gray" stopOpacity={0.25} offset="0%" />
          <Stop stopColor="gray" stopOpacity={0.12} offset="54%" />
          <Stop stopColor="gray" stopOpacity={0.1} offset="100%" />
        </LinearGradient>
        <LinearGradient x1="50%" y1="100%" x2="50%" y2="-.037%" id="prefix__D">
          <Stop stopOpacity={0.12} offset="0%" />
          <Stop stopOpacity={0.09} offset="55%" />
          <Stop stopOpacity={0.02} offset="100%" />
        </LinearGradient>
        <LinearGradient x1="49.996%" y1="100.001%" x2="49.996%" y2=".007%" id="prefix__E">
          <Stop stopColor="gray" stopOpacity={0.25} offset="0%" />
          <Stop stopColor="gray" stopOpacity={0.12} offset="54%" />
          <Stop stopColor="gray" stopOpacity={0.1} offset="100%" />
        </LinearGradient>
        <Path d="M9.535 1.563L8.905.02.693 3.497c-.381.16-.63.541-.63.965v9.13h1.622V4.88l7.85-3.317z" id="prefix__A" />
      </Defs>
      <G fill="none" fillRule="evenodd">
        ...
        <G transform="translate(65 4)">
          ...
          <Path
            ...
            opacity={0.15}
          />
          <Path fill="#535461" fillRule="nonzero" d="M13.193 211.964h8.795v9.675h-8.795z" />
          <Path fill="#000" fillRule="nonzero" opacity={0.15} d="M13.193 211.964h8.795v9.675h-8.795z" />
          <Path fill="#000" fillRule="nonzero" opacity={0.1} d="M13.193 211.759h8.795v1h-8.795z" />
          <Path fill="#535461" fillRule="nonzero" d="M279.686 221.638h-8.795v-9.675h8.795z" />
          <Path fill="#000" fillRule="nonzero" opacity={0.15} d="M279.686 221.638h-8.795v-9.675h8.795z" />
          <Path fill="#000" fillRule="nonzero" opacity={0.1} d="M279.686 212.169h-8.795v-1h8.795z" />
          <Text fill="#000" opacity={0.7} fontFamily="Helvetica" fontSize={9.58}>
          ...
          />
          <Path fill="#4D8AF0" fillRule="nonzero" d="M51.892 166.229h37.819v13.193H51.892z" />
          <Path d="M51.999 165.617h37.725V179.4H51.999z" opacity={0.05} fill="#000" fillRule="nonzero" />
          <Path
          ...
          <Path
            ...
            opacity={0.1}
          />
          <Circle fill="#333" fillRule="nonzero" cx={70.801} cy={100.705} r={19.789} />
          <Circle fill="#FDB797" fillRule="nonzero" cx={70.801} cy={105.102} r={18.91} />
          <Path
          ...
          <Path
            ...
            fillRule="nonzero"
          />
          <Ellipse fill="#FDB797" fillRule="nonzero" cx={89.711} cy={105.102} rx={1.759} ry={3.078} />
          <Ellipse fill="#FDB797" fillRule="nonzero" cx={52.771} cy={105.102} rx={1.759} ry={3.078} />
          <Path
            ...
            fillRule="nonzero"
          />
          <Circle fill="#FDB797" fillRule="nonzero" cx={55.41} cy={173.265} r={4.398} />
          <Circle fill="#FDB797" fillRule="nonzero" cx={87.952} cy={173.265} r={4.398} />
          <Path
          ...
          <G opacity={0.7} transform="translate(102.024 55.41)">
            <Path fill="url(#prefix__b)" fillRule="nonzero" d="M37.261 91.822H76.12v28.568H37.261z" />
            <Path
            ...
            <Path
              ...
              fillRule="nonzero"
            />
            <Path fill="url(#prefix__f)" fillRule="nonzero" d="M37.261 110.31H51.2v94.113H37.261z" />
            <Path fill="url(#prefix__g)" fillRule="nonzero" d="M62.185 110.31h13.939v94.113H62.185z" />
            <Path
              ...
              fillRule="nonzero"
            />
            <Ellipse fill="url(#prefix__i)" fillRule="nonzero" cx={56.692} cy={25.02} rx={20.276} ry={20.167} />
            <Ellipse fill="url(#prefix__j)" fillRule="nonzero" cx={56.692} cy={29.64} rx={19.431} ry={19.328} />
            <Path
            ...
            <Path
              ...
              fillRule="nonzero"
            />
            <Ellipse fill="url(#prefix__l)" fillRule="nonzero" cx={75.91} cy={29.64} rx={1.689} ry={3.15} />
            <Ellipse fill="url(#prefix__m)" fillRule="nonzero" cx={37.474} cy={29.64} rx={1.689} ry={3.15} />
            <Ellipse fill="url(#prefix__n)" fillRule="nonzero" cx={108.646} cy={4.853} rx={4.645} ry={4.62} />
            <Text fill="#000" fontFamily="Helvetica" fontSize={9.492}>
            ...
            <Path
              ...
              fillRule="nonzero"
            />
            <Ellipse fill="url(#prefix__q)" fillRule="nonzero" cx={4.739} cy={4.853} rx={4.645} ry={4.62} />
            <Path
          ...
          <Path fill="#4D8AF0" fillRule="nonzero" d="M139.843 147.759h37.819v28.145h-37.819z" />
          <Path
          ...
          <Path
            ...
            opacity={0.1}
          />
          <Circle fill="#814E4D" fillRule="nonzero" cx={158.753} cy={83.114} r={19.789} />
          <Circle fill="#FDB797" fillRule="nonzero" cx={158.753} cy={87.512} r={18.91} />
          <Path
          ...
          <Path
            ...
            fillRule="nonzero"
          />
          <Ellipse fill="#FDB797" fillRule="nonzero" cx={177.663} cy={87.512} rx={1.759} ry={3.078} />
          <Ellipse fill="#FDB797" fillRule="nonzero" cx={139.843} cy={87.512} rx={1.759} ry={3.078} />
          <Circle fill="#FDB797" fillRule="nonzero" cx={209.325} cy={63.325} r={4.398} />
          <Text fill="#FFF" fontFamily="Helvetica" fontSize={9.217}>
          ...
          <Path
            ...
            fillRule="nonzero"
          />
          <Circle fill="#FDB797" fillRule="nonzero" cx={108.181} cy={63.325} r={4.398} />
          <Path
          ...
          <Path
            ...
            fillRule="nonzero"
          />
          <Circle fill="url(#prefix__u)" fillRule="nonzero" cx={116.536} cy={157.873} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={116.536} cy={157.873} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__u)" fillRule="nonzero" cx={120.054} cy={157.873} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={120.054} cy={157.873} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__u)" fillRule="nonzero" cx={109.5} cy={157.873} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={109.5} cy={157.873} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__v)" fillRule="nonzero" cx={113.898} cy={155.235} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={113.898} cy={155.235} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__v)" fillRule="nonzero" cx={121.813} cy={155.235} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={121.813} cy={155.235} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__u)" fillRule="nonzero" cx={120.054} cy={154.355} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={120.054} cy={154.355} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__u)" fillRule="nonzero" cx={120.934} cy={156.994} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={120.934} cy={156.994} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__v)" fillRule="nonzero" cx={117.416} cy={155.235} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={117.416} cy={155.235} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__u)" fillRule="nonzero" cx={117.416} cy={150.837} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={117.416} cy={150.837} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__w)" fillRule="nonzero" cx={123.572} cy={152.596} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={123.572} cy={152.596} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__w)" fillRule="nonzero" cx={123.572} cy={155.235} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={123.572} cy={155.235} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__u)" fillRule="nonzero" cx={126.211} cy={155.235} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={126.211} cy={155.235} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__v)" fillRule="nonzero" cx={125.331} cy={156.114} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={125.331} cy={156.114} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__w)" fillRule="nonzero" cx={115.657} cy={152.596} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={115.657} cy={152.596} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__w)" fillRule="nonzero" cx={113.898} cy={157.873} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={113.898} cy={157.873} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__u)" fillRule="nonzero" cx={111.259} cy={157.873} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={111.259} cy={157.873} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__u)" fillRule="nonzero" cx={113.018} cy={156.994} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={113.018} cy={156.994} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__u)" fillRule="nonzero" cx={119.175} cy={156.114} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={119.175} cy={156.114} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__w)" fillRule="nonzero" cx={119.175} cy={152.596} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={119.175} cy={152.596} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__w)" fillRule="nonzero" cx={120.934} cy={155.235} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={120.934} cy={155.235} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__u)" fillRule="nonzero" cx={119.175} cy={149.958} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={119.175} cy={149.958} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__w)" fillRule="nonzero" cx={120.054} cy={151.717} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={120.054} cy={151.717} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__w)" fillRule="nonzero" cx={120.934} cy={152.596} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={120.934} cy={152.596} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__u)" fillRule="nonzero" cx={122.693} cy={151.717} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={122.693} cy={151.717} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__w)" fillRule="nonzero" cx={122.693} cy={153.476} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={122.693} cy={153.476} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__v)" fillRule="nonzero" cx={116.536} cy={151.717} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={116.536} cy={151.717} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__w)" fillRule="nonzero" cx={113.018} cy={156.114} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={113.018} cy={156.114} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__u)" fillRule="nonzero" cx={115.657} cy={153.476} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={115.657} cy={153.476} r={1.319} />
          <Path
            d="M114.645 153.482c.006-.406.336-.77.842-.929.505-.159 1.09-.082 1.489.197-.234-.373-.746-.607-1.302-.593-.555.014-1.046.272-1.245.656-.199.383-.068.818.332 1.103a.794.794 0 01-.116-.434z"
            fill="#FFF"
            fillRule="nonzero"
            opacity={0.2}
          />
          <Circle fill="url(#prefix__v)" fillRule="nonzero" cx={110.38} cy={156.994} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={110.38} cy={156.994} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__w)" fillRule="nonzero" cx={123.572} cy={156.114} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={123.572} cy={156.114} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__v)" fillRule="nonzero" cx={117.416} cy={149.078} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={117.416} cy={149.078} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__u)" fillRule="nonzero" cx={114.777} cy={151.717} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={114.777} cy={151.717} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__u)" fillRule="nonzero" cx={113.018} cy={154.355} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={113.018} cy={154.355} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__u)" fillRule="nonzero" cx={114.777} cy={156.994} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={114.777} cy={156.994} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__u)" fillRule="nonzero" cx={116.536} cy={155.235} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={116.536} cy={155.235} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__u)" fillRule="nonzero" cx={117.416} cy={156.994} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={117.416} cy={156.994} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__u)" fillRule="nonzero" cx={127.09} cy={157.873} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={127.09} cy={157.873} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__u)" fillRule="nonzero" cx={125.331} cy={157.873} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={125.331} cy={157.873} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__w)" fillRule="nonzero" cx={121.813} cy={157.873} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={121.813} cy={157.873} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={121.813} cy={156.994} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__u)" fillRule="nonzero" cx={118.295} cy={157.873} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={118.295} cy={157.873} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__v)" fillRule="nonzero" cx={117.416} cy={152.596} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={117.416} cy={152.596} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__v)" fillRule="nonzero" cx={119.175} cy={154.355} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={119.175} cy={154.355} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__w)" fillRule="nonzero" cx={116.536} cy={150.837} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={116.536} cy={150.837} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__v)" fillRule="nonzero" cx={118.295} cy={150.837} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={118.295} cy={150.837} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__w)" fillRule="nonzero" cx={120.934} cy={150.837} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={120.934} cy={150.837} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__v)" fillRule="nonzero" cx={113.898} cy={153.476} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={113.898} cy={153.476} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__v)" fillRule="nonzero" cx={114.777} cy={155.235} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={114.777} cy={155.235} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__w)" fillRule="nonzero" cx={115.657} cy={156.994} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={115.657} cy={156.994} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__v)" fillRule="nonzero" cx={119.175} cy={156.114} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={119.175} cy={156.114} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__v)" fillRule="nonzero" cx={123.572} cy={155.235} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={123.572} cy={155.235} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__v)" fillRule="nonzero" cx={124.452} cy={154.355} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={124.452} cy={154.355} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={121.813} cy={154.355} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__u)" fillRule="nonzero" cx={126.211} cy={156.994} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={126.211} cy={156.994} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__w)" fillRule="nonzero" cx={120.054} cy={157.873} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={120.054} cy={157.873} r={1.319} />
          <Path
            d="M119.042 158.76c.007-.407.337-.771.842-.93.505-.159 1.09-.082 1.49.197-.234-.373-.747-.606-1.302-.593-.556.014-1.046.272-1.245.656-.2.383-.069.818.332 1.103a.794.794 0 01-.117-.434z"
            fill="#FFF"
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__v)" fillRule="nonzero" cx={113.018} cy={157.873} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={113.018} cy={157.873} r={1.319} />
          <Path
            d="M112.006 157.88c.006-.406.337-.77.842-.93.505-.158 1.09-.081 1.49.197-.234-.373-.747-.606-1.302-.592-.556.014-1.046.272-1.245.655-.2.384-.069.818.332 1.103a.794.794 0 01-.117-.433z"
            fill="#FFF"
            fillRule="nonzero"
            opacity={0.2}
          />
          <Circle fill="url(#prefix__v)" fillRule="nonzero" cx={111.259} cy={156.114} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={111.259} cy={156.114} r={1.319} />
          <Path
          ...
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__v)" fillRule="nonzero" cx={112.139} cy={153.476} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={112.139} cy={153.476} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__w)" fillRule="nonzero" cx={113.898} cy={150.837} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={113.898} cy={150.837} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__u)" fillRule="nonzero" cx={123.572} cy={157.873} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={123.572} cy={157.873} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Path fill="url(#prefix__x)" fillRule="nonzero" d="M125.55 180.301h-14.56l-3.689-21.988h21.988z" />
          <Path fill="#FFF" fillRule="nonzero" d="M125.699 179.422h-13.977l-3.541-21.109h21.108z" />
          <Path
            fill="#6C63FF"
            fillRule="nonzero"
            d="M108.18 158.313h3.616l3.42 21.109h-3.519zm21.11 0h-3.592l-3.445 21.109h3.494zm-12.314 0h3.518v21.108h-3.518z"
          />
          <Circle fill="url(#prefix__v)" fillRule="nonzero" cx={112.139} cy={154.355} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={112.139} cy={154.355} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__u)" fillRule="nonzero" cx={114.777} cy={150.837} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={114.777} cy={150.837} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__v)" fillRule="nonzero" cx={110.38} cy={156.114} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={110.38} cy={156.114} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__w)" fillRule="nonzero" cx={108.62} cy={147.319} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={108.62} cy={147.319} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__w)" fillRule="nonzero" cx={114.777} cy={140.283} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={114.777} cy={140.283} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__u)" fillRule="nonzero" cx={119.175} cy={134.127} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={119.175} cy={134.127} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__u)" fillRule="nonzero" cx={128.849} cy={146.44} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={128.849} cy={146.44} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__v)" fillRule="nonzero" cx={135.886} cy={156.114} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={135.886} cy={156.114} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__v)" fillRule="nonzero" cx={108.62} cy={178.982} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={108.62} cy={178.982} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__v)" fillRule="nonzero" cx={106.861} cy={176.343} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={106.861} cy={176.343} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__v)" fillRule="nonzero" cx={105.102} cy={164.03} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={105.102} cy={164.03} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__w)" fillRule="nonzero" cx={130.608} cy={178.102} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={130.608} cy={178.102} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__v)" fillRule="nonzero" cx={133.247} cy={176.343} r={1.319} />
          <Circle fill="#FBC02D" fillRule="nonzero" cx={133.247} cy={176.343} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__w)" fillRule="nonzero" cx={133.247} cy={178.102} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={133.247} cy={178.102} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Circle fill="url(#prefix__w)" fillRule="nonzero" cx={127.97} cy={178.102} r={1.319} />
          <Circle fill="#FDD835" fillRule="nonzero" cx={127.97} cy={178.102} r={1.319} />
          <Path
            ...
            opacity={0.2}
          />
          <Text fill="#000" opacity={0.7} fontFamily="Helvetica" fontSize={9.953}>
          ...
          />
          <Path fill="#4D8AF0" fillRule="nonzero" d="M204.928 172.386h38.699v14.072h-38.699z" />
          <Path d="M205.129 172.495h38.407v14.194h-38.407z" opacity={0.05} fill="#000" fillRule="nonzero" />
          <Path
          ...
          <Path
            ...
            opacity={0.1}
          />
          <Circle fill="#FFCF51" fillRule="nonzero" cx={224.277} cy={105.542} r={20.229} />
          <Circle fill="#FDB797" fillRule="nonzero" cx={224.277} cy={109.94} r={19.349} />
          <Ellipse fill="#FDB797" fillRule="nonzero" cx={243.627} cy={110.38} rx={1.759} ry={3.078} />
          <Ellipse fill="#FDB797" fillRule="nonzero" cx={205.807} cy={110.38} rx={1.759} ry={3.078} />
          <Path
          ...
          <G transform="translate(246.265 157.434)">
            ...
            <G mask="url(#prefix__B)" fill="#6C63FF" fillRule="nonzero">
          ...
          />
          <Path fill="#6C63FF" fillRule="nonzero" d="M199.93 179.422h-10.82l-2.652-26.386h15.831z" />
          <Path fill="#6C63FF" fillRule="nonzero" d="M184.699 152.157h18.47v1.759h-18.47z" />
          <Circle fill="url(#prefix__D)" fillRule="nonzero" cx={194.373} cy={164.47} r={4.398} />
          <Circle fill="#FFF" fillRule="nonzero" cx={193.934} cy={164.91} r={3.958} />
          <Path
